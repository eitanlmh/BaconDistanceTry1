...
from app.backend.modules.bacon_distance_modules.graph_cache import load_graph
import os
import pickle
import time
...
def get_bacon_distance(actor_name, graph, actor_name_to_id):
    ...
    # graph, actor_name_to_id, actor_name_to_movie_ids = load_graph()

    try:
        # distance = find_bacon_distance(graph, actor_name_to_id, actor_name_to_movie_ids)
